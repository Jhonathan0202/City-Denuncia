...
const Header: React.FC = (): JSX.Element => {
  return (
    <>
        <header>
            <h1><span style={{ color: 'black' }}>City</span>Denúncia</h1>
            <nav>
                <ul>
                    <li>
                        <NavLink to="/criar-denuncia">Criar denúncia</NavLink>
                    </li>
                    <li>
                        <NavLink to="/">Consultar denúncias</NavLink>
                    </li>
                </ul>
            </nav>
            <div>
                <button aria-label="Configurações da conta" className="accont-icon">
